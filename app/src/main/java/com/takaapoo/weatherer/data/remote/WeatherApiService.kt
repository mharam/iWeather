...
//        @Query("current") currentWeather: Boolean,
        @Query("timezone") timeZone: String = "GMT",
        @Query("past_days") pastDays: Int
    ): Response<HourlyWeatherPack>

    @GET("""v1/forecast/?daily=weathercode,temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max,precipitation_sum,precipitation_probability_max,windspeed_10m_max,windgusts_10m_max&forecast_days=16""")
